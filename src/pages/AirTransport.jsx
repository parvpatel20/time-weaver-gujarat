...
const AirTransport = () => {
  ...
  const airports = [
    { 
      name: 'SVPI Airport', 
      description: 'Ahmedabad International Airport overview',
      image: airportImage,
      link: '/details/svpi-airport'
    },
    { 
      name: 'Regional Connectivity', 
      description: 'Surat, Vadodara and Rajkot routes',
      image: airportImage,
      link: '/articles/gujarat-trade-gateway'
    },
    { 
      name: 'Cargo & Logistics', 
      description: 'Air cargo operations powering exports',
      image: airportImage,
      link: '/articles/gujarat-trade-gateway'
    },
  ];
