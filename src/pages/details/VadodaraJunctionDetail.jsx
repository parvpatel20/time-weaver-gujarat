...
import stationImage from '@/assets/vadodara-junction.jpg';
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-5xl md:text-6xl font-display font-bold">
              Vadodara Railway Junction
            </h1>
            <p className="text-xl text-muted-foreground italic font-display">
              Royal Indo-Saracenic Heritage and a Major Western Railway Hub
            </p>
          </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl">
            <img
              src={stationImage}
              alt="Vadodara Junction - heritage architecture"
            ...
            <CardContent className="p-8 space-y-6">
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="text-center p-4 bg-accent/5 rounded-lg">
                  ...
                  <div className="text-2xl font-display font-bold text-accent">1850s</div>
                  <p className="text-sm text-muted-foreground">Established</p>
                </div>
                <div className="text-center p-4 bg-accent/5 rounded-lg">
                  <Users className="h-8 w-8 mx-auto text-accent mb-2" />
                  <div className="text-2xl font-display font-bold text-accent">100K+</div>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Vadodara Junction is one of Gujarat's busiest stations, known for its heritage
                  Indo-Saracenic architecture and strategic position on the Western Railway network.
                  It connects Mumbai–Delhi–Ahmedabad routes and serves as a key operational hub.
                </p>
              </div>
            </CardContent>
          </Card>
