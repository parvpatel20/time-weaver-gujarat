  ...
  const tourLocations = [
    {
      ...
      youtubeUrl: 'https://www.youtube.com/watch?v=8w08jvY6JPU',
    ...
    },
    {
      ...
      youtubeUrl: 'https://www.youtube.com/watch?v=6n8g8Q2a5XQ',
    ...
    },
    {
      ...
      youtubeUrl: 'https://www.youtube.com/watch?v=9p_9ZfU2sQk',
            ...
            <Card className="overflow-hidden">
              <div className="relative bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                <iframe
                  ...
                  src={`https://www.youtube.com/embed/${currentLocation.youtubeUrl.split('v=')[1]}`}
            ...
            <Card>
              <CardContent className="p-8 space-y-6">
                ...
                <div className="flex gap-3 pt-4">
                  <a href={currentLocation.youtubeUrl} target="_blank" rel="noreferrer" className="flex-1">
                    <Button className="w-full">Open on YouTube</Button>
                  </a>
                  <a href={currentLocation.youtubeUrl} target="_blank" rel="noreferrer" className="flex-1">
