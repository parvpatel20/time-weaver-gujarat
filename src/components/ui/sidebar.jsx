...
const SidebarProvider = React.forwardRef(({ defaultOpen = true, open: openProp, onOpenChange: onOpenChangeProp, className, style, children, ...props }, ref) => {
  const isMobile = useIsMobile();
  const [openMobile, setOpenMobile] = React.useState(false);

  // This is the internal state of the sidebar. If `openProp` is provided the component is controlled.
  ...
  const setOpen = React.useCallback(
    (value) => {
      ...
      // Persist the state in a cookie for basic persistence across reloads.
      try {
